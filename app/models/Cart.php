...
class Cart extends AppModel
{
    public function addToCart($product, $qty = 1, $mod = null)
    {
        ...
        $_SESSION['cart.qty'] = isset($_SESSION['cart.qty']) ? $_SESSION['cart.qty'] + $qty : $qty;    //если есть в корзине кол-во то прибавим к текущему иначе просто возьмем кол-во
