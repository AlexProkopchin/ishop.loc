	...
	<div class="single contact">
		<div class="container">
			<div class="single-main">
				...
				<div class="sngl-top">
					<div class="col-md-5 single-top-left data-image-gallery">
						<?php if($gallery): ?>	
					...
					<div class="col-md-7 single-top-right">
						...
						<h2><?=$product->title;?></h2>
							...
							<?php if($product->old_price): ?>
                                ...
                                <span><?php echo round((($product->old_price - $product->price) * 100) / $product->old_price).' %';?></span>
                                <?php endif; ?>
							...
							<div class="product-main simpleCart_shelfItem">
								...
								<div class="product-bottom">
									...
									<h4>
                                		...
                                		<span><?php echo round((($item['old_price'] - $item['price']) * 100) / $item['old_price']).' %';?></span>
                                		<?php endif; ?>
									</h4>
								</div>
								<div class="srch">
